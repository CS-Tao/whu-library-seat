...
<a target="_blank" href="https://github.com/CS-Tao/whu-library-seat-mobile/releases/tag/v1.6.0">移动端 v1.6.0 更新日志</a>

<a target="_blank" href="https://github.com/CS-Tao/whu-library-seat/releases/tag/v1.8.0">桌面端 v1.8.0 更新日志</a>

#### 功能说明(桌面端 v1.8.0, 移动端 v1.6.0)
...
- 本软件为图书馆抢座软件移动版，是原桌面端软件的衍生版本，布局和样式可能和一些设备不太兼容，最新版为 v1.6.0，桌面端最新版为 v1.8.0
