<template>
	<div class="body">
    <el-form :model="form" ref="seatForm" label-width="50px" class="flex-row form">
      <div style="margin:auto;text-align:center;">
        <el-form-item prop="date" label="日期">
          <el-date-picker type="date" placeholder="请选择日期" v-model="form.date" class="input"></el-date-picker>
        </el-form-item>
        <el-form-item label="场馆">
          <el-select v-model="form.library" placeholder="请选择场馆" class="input">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="房间">
          <el-select v-model="form.room" placeholder="请选择房间" class="input">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="date" label="开始">
          <el-select v-model="form.beginTime" placeholder="请选择开始时间" class="input">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="date" label="结束">
          <el-select v-model="form.endTime" placeholder="请选择结束时间" class="input">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="seatNum" label="位号" :inline="true" style="flex-col">
          <el-input-number v-model="form.seatNum" :min="1" :max="10" label="座位号" class="num"></el-input-number>
...
export default {
  ...
  mounted () {
    ...
    this.form.library = this.settingLibrary
    this.form.room = this.settingRoom
    this.form.beginTime = this.settingBeginTime
    this.form.endTime = this.settingEndTime
    this.form.seatNum = this.settingSeatNum
    this.form.changer = this.settingBattery
    this.form.sun = this.settingSun
  ...
  methods: {
    ...
    loadLibrary () {},
    loadRoom (library) {},
    loadTimeSpan (date, library, room) {},
    loadNumSpan (library, room) {},
